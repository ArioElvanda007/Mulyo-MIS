			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<br /><br />
						<form action="<?= site_url('Basic/info_pasar_add') ?>" method="POST">
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Job No.</label>
										<input type="text" class="form-control" readonly placeholder="GENERATED BY SYSTEM">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" required name="NamaPaket">
									</div>
									<div class="form-group">
										<label>HPS (Rp)*</label>
										<input type="number" class="form-control" required name="HPS">
									</div>
									<div class="form-group">
										<label>SYC/MYC*</label>
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" required name="PeriodeTriwulan">
									</div>
									<div class="form-group">
										...
										<div class="form-group">
											...
											<select class="form-control" name="NamaInstansi" id="NamaInstansi" onchange="changeInstansi()">
												<?php foreach ($instansi as $row => $value): ?>
													<option value="<?= $value->Id_Instansi ?>"><?= $value->NamaDirektorat ?></option>
												<?php endforeach ?>
											</select>
										</div>
										<div class="form-group">
		...
		$.ajax({
			...
			success:function(res) {
				...
				$.each(JSON.parse(res), function(i, v) {
					_option += '<option value="'+v.Id_SubInstansi+'">'+v.NamaSubInstansi+'</option>';
				})
